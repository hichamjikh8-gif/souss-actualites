 ...
 * Description: Ajoute un bouton vert "Partagez sur WhatsApp" sous le titre de
...
/*
 * IMPORTANT - Anti-recursion:
 * Le filtre the_title > sa_whatsapp_button() > get_the_title() aurait
 * re-declenche the_title a l'infini (fatal PHP, page blanche sur les
 * articles). Le flag global sa_whatsapp_rendering coupe la recursion et le
 * titre du bouton est lu via get_post_field (pas de nouveau tour de filtre).
 */
$GLOBALS['sa_whatsapp_rendering'] = false;
...
add_filter( 'the_title', function ( $title, $post_id ) {
	...
	if ( $GLOBALS['sa_whatsapp_rendering'] ) {
		return $title;
	}

	$GLOBALS['sa_whatsapp_rendering'] = true;
	$result                          = $title . sa_whatsapp_button( $post );
	$GLOBALS['sa_whatsapp_rendering'] = false;
...
/**
 * Construit le bouton de partage WhatsApp (wa.me) avec titre et URL.
 */
